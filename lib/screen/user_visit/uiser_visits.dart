...
class UserVisited extends StatefulWidget {
  const UserVisited({Key? key}) : super(key: key);

  @override
  _UserVisitedState createState() => _UserVisitedState();
}

class _UserVisitedState extends State<UserVisited> {
  @override
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    Icon(Icons.remove_red_eye, color: AppColor.button),
                    Padding(
