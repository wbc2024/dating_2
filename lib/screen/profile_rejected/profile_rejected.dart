...
class ProfileRejected extends StatefulWidget {
  const ProfileRejected({Key? key}) : super(key: key);

  @override
  _ProfileRejectedState createState() => _ProfileRejectedState();
}

class _ProfileRejectedState extends State<ProfileRejected> {
  @override
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                   Icon(Icons.clear, color: AppColor.button),
                    Padding(
                      padding: const EdgeInsets.only(left: 15),
                      child: Text("Profile you rejected",
                          style: TextStyle(
